  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Obtener datos del usuario (asumimos usuario con ID 3 como simulación de autenticación)
              ...
              <div className="bg-dark-card rounded-lg shadow-lg mb-6 overflow-hidden">
                <div className="p-6">
                  <div className="flex flex-col md:flex-row items-center md:items-start">
                    <div className="w-24 h-24 md:w-32 md:h-32 bg-red-600 rounded-full flex items-center justify-center mb-4 md:mb-0 md:mr-6">
                    ...
                    <div className="text-center md:text-left flex-1">
                      ...
                      <p className="text-light-gray">{user.academicYear}</p>
                    </div>
